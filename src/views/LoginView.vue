      ...
      <div class="w-full bg-white rounded-lg shadow-lg border border-gray-200 md:mt-0 sm:max-w-md xl:p-0 relative z-10">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">
            <a href="javascript:void(0)" class="flex items-center text-2xl font-semibold text-gray-900 relative z-10">
          ...
          <form class="space-y-4 md:space-y-6" @submit.prevent="login">
            ...
            <div class="flex items-center justify-between">
              <RouterLink to="/nova-conta" class="text-sm font-medium text-atenas hover:underline">Não tem conta? Cadastre-se</RouterLink>
            </div>
            <button type="submit" class="w-full text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-md px-5 py-3.5 text-center">
